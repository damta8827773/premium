...
function renderAnnouncements() {
  if (!announcements.length) {
    document.getElementById('announcements-list').innerHTML = '<div class="text-center py-10 text-gray-400 card-premium"><p>Belum ada pengumuman</p></div>';
    return;
  }
  document.getElementById('announcements-list').innerHTML = `<div class="space-y-3">${announcements.map(a => {
    ...
    return `<div class="card-premium p-5 announcement-card cursor-pointer hover:shadow-md transition-shadow" onclick="showDetail('${a.id}')">
